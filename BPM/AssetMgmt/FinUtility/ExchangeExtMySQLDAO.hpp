...
#ifndef _DERIVATIVE_EXCHANGEEXTMYSQLDAO_H_
#define _DERIVATIVE_EXCHANGEEXTMYSQLDAO_H_
...
namespace derivative
{
	...
	public:
		...
		enum {TYPEID = CLASS_EXCHANGEEXTMYSQLDAO_TYPE};
...
#endif /* _DERIVATIVE_EXCHANGEEXTMYSQLDAO_H_ */
