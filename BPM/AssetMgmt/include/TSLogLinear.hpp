...
#ifndef _DERIVATIVE_TSLOGLINEAR_H_
#define _DERIVATIVE_TSLOGLINEAR_H_
...
namespace derivative
{
	...
	class PRIMARYASSET_EXT_API TSLogLinear : public TSBootstrap
	{
	public:

		enum {TYPEID = CLASS_TSLOGLINEAR_TYPE};
		...
		inline TSLogLinear(const TSLogLinear& ts) 
			: TSBootstrap(ts.T.copy(),ts.B.copy()) 
		{ };
	...
	private:
		...
		/// disallow the operator= functions
		TSLogLinear& operator=(const TSLogLinear& );
	};
	

} /* namespace derivative */

#endif /* _DERIVATIVE_TSLOGLINEAR_H_ */
