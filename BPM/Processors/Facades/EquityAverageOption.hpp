...
namespace derivative
{
	...
	/// Create the EquityAverageOption class
	class FACADES_DLL_API EquityAverageOption : virtual public EquityOption, 
	...
	public:
		...
		/// Constructor with Exemplar for the Creator EquityAverageOption object
		EquityAverageOption(const Exemplar &ex);

		/// constructor for Make
		EquityAverageOption(const Name& nm);

		/// Destructor
		virtual ~EquityAverageOption()
		{}
