...
#ifndef _DERIVATIVE_EXCHANGERATEBARRIEROPTION_H_
#define _DERIVATIVE_EXCHANGERATEBARRIEROPTION_H_
...
namespace derivative
{
	...
	/// Create the ExchangeRateBarrierOption class
	class FACADES_DLL_API ExchangeRateBarrierOption : virtual public ExchangeRateOption,
		virtual public IObject,
		virtual public IMake
	{
	public:

		enum { TYPEID = CLASS_EXCHANGERATEBARRIEROPTION_TYPE };

		/// Constructor with Exemplar for the Creator ExchangeRateBarrierOption object
		ExchangeRateBarrierOption(const Exemplar &ex);

		/// constructor for Make
		ExchangeRateBarrierOption(const Name& nm);

		/// Destructor
		virtual ~ExchangeRateBarrierOption()
		{}
...
#endif /* _DERIVATIVE_EXCHANGERATEBARRIEROPTION_H_ */
