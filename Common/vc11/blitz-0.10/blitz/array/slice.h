...
public:
    static const int isValidType = 0, blitz_rank = 0, isPick = 0;
};

template<>
class ArraySectionInfo<Range> {
public:
	static const int isValidType = 1, blitz_rank = 1, isPick = 0;
};

template<>
class ArraySectionInfo<int> {
public:
    static const int isValidType = 1, blitz_rank = 0, isPick = 0;
};
...
public:
    static const int 
        ...
        blitz_rank          = ArraySectionInfo<T1>::blitz_rank
                      + ArraySectionInfo<T2>::blitz_rank
                      + ArraySectionInfo<T3>::blitz_rank
                      + ArraySectionInfo<T4>::blitz_rank
                      + ArraySectionInfo<T5>::blitz_rank
                      + ArraySectionInfo<T6>::blitz_rank
                      + ArraySectionInfo<T7>::blitz_rank
                      + ArraySectionInfo<T8>::blitz_rank
                      + ArraySectionInfo<T9>::blitz_rank
                      + ArraySectionInfo<T10>::blitz_rank
                      + ArraySectionInfo<T11>::blitz_rank,
    ...
    typedef Array<T_numtype,blitz_rank> T_slice;
};
