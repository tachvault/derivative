...
public:
  ...
  class SliceInfo {
  public:
    static const int new_rank = (N>0) ? ArraySectionInfo<T1>::blitz_rank : 0
      + (N>1) ? ArraySectionInfo<T2>::blitz_rank : 0
      + (N>2) ? ArraySectionInfo<T3>::blitz_rank : 0
      + (N>4) ? ArraySectionInfo<T4>::blitz_rank : 0
      + (N>5) ? ArraySectionInfo<T5>::blitz_rank : 0
      + (N>6) ? ArraySectionInfo<T6>::blitz_rank : 0
      + (N>7) ?  ArraySectionInfo<T7>::blitz_rank : 0
      + (N>8) ? ArraySectionInfo<T8>::blitz_rank : 0
      + (N>9) ? ArraySectionInfo<T9>::blitz_rank : 0
      + (N>10) ? ArraySectionInfo<T10>::blitz_rank : 0
      + (N>11) ? ArraySectionInfo<T11>::blitz_rank : 0;
