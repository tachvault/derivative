...
#ifndef _DERIVATIVE_EQUITYBARRIEROPTMESSAGE_H_
#define _DERIVATIVE_EQUITYBARRIEROPTMESSAGE_H_
...
{
	class MESSAGES_DLL_API EquityBarrierOptMessage : public std::enable_shared_from_this<EquityBarrierOptMessage>,
		virtual public VanillaOptMessage
	{
	public:

		enum { MSGID = EQUITY_BARRIER_OPTION };
		...
		virtual ~EquityBarrierOptMessage()
		{}
		...
		virtual EquityBarrierOptMessage::BarrierOptionTypeEnum  ParseBarrierType(const std::map<string_t, string_t>& query_strings);
...
#endif /* _DERIVATIVE_EQUITYBARRIEROPTMESSAGE_H_ */
