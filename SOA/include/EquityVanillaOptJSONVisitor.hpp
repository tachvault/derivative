...
#ifndef _DERIVATIVE_EQUITYVANILLAOPTJSONVISITOR_H_
#define _DERIVATIVE_EQUITYVANILLAOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityVanillaOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYVANILLAOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYVANILLAOPTJSONVISITOR_H_ */
