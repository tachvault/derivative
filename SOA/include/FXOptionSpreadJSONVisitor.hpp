...
#ifndef _DERIVATIVE_EQUITYOPTIONSPREADJSONVISITOR_H_
#define _DERIVATIVE_EQUITYOPTIONSPREADJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityOptionSpreadJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYOPTIONSPREADJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYOPTIONSPREADJSONVISITOR_H_ */
