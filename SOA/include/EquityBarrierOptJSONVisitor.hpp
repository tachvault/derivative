...
#ifndef _DERIVATIVE_EQUITYBARRIEROPTJSONVISITOR_H_
#define _DERIVATIVE_EQUITYBARRIEROPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityBarrierOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYBARRIEROPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYBARRIEROPTJSONVISITOR_H_ */
