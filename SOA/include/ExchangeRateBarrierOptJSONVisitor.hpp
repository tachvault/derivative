...
#ifndef _DERIVATIVE_EXCHANGERATEBARRIEROPTJSONVISITOR_H_
#define _DERIVATIVE_EXCHANGERATEBARRIEROPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API ExchangeRateBarrierOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EXCHANGERATEBARRIEROPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EXCHANGERATEBARRIEROPTJSONVISITOR_H_ */
