...
#ifndef _DERIVATIVE_FUTURESVANILLAOPTJSONVISITOR_H_
#define _DERIVATIVE_FUTURESVANILLAOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API FuturesVanillaOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_FUTURESVANILLAOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_FUTURESVANILLAOPTJSONVISITOR_H_ */
