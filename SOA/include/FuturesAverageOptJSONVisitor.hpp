...
#ifndef _DERIVATIVE_FUTURESAVERAGEOPTJSONVISITOR_H_
#define _DERIVATIVE_FUTURESAVERAGEOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API FuturesAverageOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_FUTURESAVERAGEOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_FUTURESAVERAGEOPTJSONVISITOR_H_ */
