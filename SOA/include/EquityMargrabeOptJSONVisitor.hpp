...
#ifndef _DERIVATIVE_EQUITYMARGRABEOPTJSONVISITOR_H_
#define _DERIVATIVE_EQUITYMARGRABEOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityMargrabeOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYMARGRABEOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYMARGRABEOPTJSONVISITOR_H_ */
