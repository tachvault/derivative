...
#ifndef _DERIVATIVE_EXCHANGERATEOPTIONSPREADJSONVISITOR_H_
#define _DERIVATIVE_EXCHANGERATEOPTIONSPREADJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API ExchangeRateOptionSpreadJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EXCHANGERATEOPTIONSPREADJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EXCHANGERATEOPTIONSPREADJSONVISITOR_H_ */
