...
#ifndef _DERIVATIVE_EXCHANGERATEVANILLAOPTJSONVISITOR_H_
#define _DERIVATIVE_EXCHANGERATEVANILLAOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API ExchangeRateVanillaOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EXCHANGERATEVANILLAOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EXCHANGERATEVANILLAOPTJSONVISITOR_H_ */
