...
#ifndef _DERIVATIVE_FUTURESBARRIEROPTJSONVISITOR_H_
#define _DERIVATIVE_FUTURESBARRIEROPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API FuturesBarrierOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_FUTURESBARRIEROPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_FUTURESBARRIEROPTJSONVISITOR_H_ */
