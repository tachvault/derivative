...
#ifndef _DERIVATIVE_EQUITYLOOKBACKOPTJSONVISITOR_H_
#define _DERIVATIVE_EQUITYLOOKBACKOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityLookBackOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYLOOKBACKOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYLOOKBACKOPTJSONVISITOR_H_ */
