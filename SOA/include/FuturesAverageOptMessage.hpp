...
#ifndef _DERIVATIVE_FUTURESAVERAGEOPTMESSAGE_H_
#define _DERIVATIVE_FUTURESAVERAGEOPTMESSAGE_H_
...
{
	class MESSAGES_DLL_API FuturesAverageOptMessage : public std::enable_shared_from_this<FuturesAverageOptMessage>,
		virtual public VanillaOptMessage
	{
	public:

		enum { MSGID = FUTURES_AVERAGE_OPTION };
		...
		virtual ~FuturesAverageOptMessage()
		{}
...
#endif /* _DERIVATIVE_FUTURESAVERAGEOPTMESSAGE_H_ */
