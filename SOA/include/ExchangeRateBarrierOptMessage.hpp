...
#ifndef _DERIVATIVE_EXCHANGERATEBARRIEROPTMESSAGE_H_
#define _DERIVATIVE_EXCHANGERATEBARRIEROPTMESSAGE_H_
...
{
	class MESSAGES_DLL_API ExchangeRateBarrierOptMessage : public std::enable_shared_from_this<ExchangeRateBarrierOptMessage>,
		virtual public VanillaOptMessage
	{
	public:

		enum { MSGID = EXCHANGERATE_BARRIER_OPTION };
		...
		virtual ~ExchangeRateBarrierOptMessage()
		{}
		...
		virtual ExchangeRateBarrierOptMessage::BarrierOptionTypeEnum  ParseBarrierType(const std::map<string_t, string_t>& query_strings);
...
#endif /* _DERIVATIVE_EXCHANGERATEBARRIEROPTMESSAGE_H_ */
