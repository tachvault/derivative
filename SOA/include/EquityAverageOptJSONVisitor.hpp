...
#ifndef _DERIVATIVE_EQUITYAVERAGEOPTJSONVISITOR_H_
#define _DERIVATIVE_EQUITYAVERAGEOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API EquityAverageOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EQUITYAVERAGEOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EQUITYAVERAGEOPTJSONVISITOR_H_ */
