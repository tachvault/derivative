...
#ifndef _DERIVATIVE_EXCHANGERATEAVERAGEOPTJSONVISITOR_H_
#define _DERIVATIVE_EXCHANGERATEAVERAGEOPTJSONVISITOR_H_
...
{
	class MESSAGES_DLL_API ExchangeRateAverageOptJSONVisitor : public IVisitor
	{
	public:

		enum { TYPEID = CLASS_EXCHANGERATEAVERAGEOPTJSONVISITOR_TYPE };
...
#endif /* _DERIVATIVE_EXCHANGERATEAVERAGEOPTJSONVISITOR_H_ */
